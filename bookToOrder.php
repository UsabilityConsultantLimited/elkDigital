...
<div class="form-group">
  ...
  <input  name="first_name" placeholder="First Name" class="form-control"  type="text" required data-validation-required-message="Please enter your name.">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <input name="contact_no" placeholder="(234)" class="form-control" type="text" required>
    </div>
  </div>
</div>
